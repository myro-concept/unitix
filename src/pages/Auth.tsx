  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10 relative overflow-hidden bg-[#fafaf9]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[12%] w-12 h-12 rounded-lg bg-[#FF0048]/[0.08] rotate-12 blur-sm" />
        <div className="absolute bottom-[15%] left-[15%] w-10 h-10 rounded-full bg-[#FF0048]/10 blur-sm" />
        <div className="absolute bottom-[25%] right-[8%] w-14 h-14 rounded-lg bg-[#FF0048]/[0.06] -rotate-12 blur-sm" />
        <div className="absolute top-[50%] left-[5%] w-8 h-8 rounded-full bg-muted-foreground/5 blur-sm" />
        <div className="absolute top-[40%] right-[5%] w-20 h-20 rounded-full bg-[#FF0048]/[0.05] blur-md" />
      </div>
      ...
      >
        ...
        {/* Auth card */}
        <div className="bg-card rounded-3xl border border-[#FF0048]/10 shadow-[0_20px_60px_rgba(255,0,72,0.10)] p-6">
          <Tabs defaultValue="login">
            <TabsList className="grid w-full grid-cols-2 rounded-full bg-muted p-1 mb-6">
              <TabsTrigger value="login" className="rounded-full data-[state=active]:bg-white data-[state=active]:text-[#FF0048] data-[state=active]:shadow-sm text-sm font-semibold">
                Log in
              </TabsTrigger>
              <TabsTrigger value="signup" className="rounded-full data-[state=active]:bg-white data-[state=active]:text-[#FF0048] data-[state=active]:shadow-sm text-sm font-semibold">
                Sign up
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="login" className="mt-0">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full rounded-full h-11 bg-[#FF0048] text-white hover:bg-[#e60041] font-semibold" disabled={loading}>
            ...
            <TabsContent value="signup" className="mt-0">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="school-signup" className="text-sm font-medium text-foreground">School</Label>
                  <select
                    id="school-signup"
                    required
                    value={signupSchool}
                    onChange={(e) => setSignupSchool(e.target.value)}
                    className="w-full rounded-full h-11 px-4 border border-input bg-background text-sm outline-none focus:ring-2 focus:ring-[#FF0048]/25 focus:border-[#FF0048]"
                  >
        ...
        <Link
          to="/terms-of-service"
          className="text-[#FF0048] hover:underline font-medium"
        >
          Terms of Service
        </Link>{" "}
        and{" "}
